...
def main(page: ft.Page):
    ...
    perfil = ft.Container(
        border=ft.Border(top=ft.BorderSide(width=2, color='white'), bottom=ft.BorderSide(width=2, color=ft.colors.WHITE), left=ft.BorderSide(1, color=ft.colors.WHITE), right=ft.BorderSide(1, color=ft.colors.WHITE)),
        margin=10,
        border_radius=5,
        expand=2,
        content=ft.Column(
        ...
        content=ft.Row(
            [
                ft.Container(
                    ...
                    border_radius=100,
                    border=ft.Border(top=ft.BorderSide(1, color=ft.colors.WHITE), right=ft.BorderSide(1, color=ft.colors.WHITE),left=ft.BorderSide(1, color=ft.colors.WHITE),bottom=ft.BorderSide(1, color=ft.colors.WHITE)),
                    content=ft.Row(
                        [
            ...
            [
                ft.Row(
                    [
                        ...
                        ft.ElevatedButton('FINALIZAR', height=20, width=120, bgcolor=ft.colors.RED_300, color=ft.colors.WHITE),                   
                    ],
                ...
                ft.Row(
                    [
                        ...
                        ft.TextField('110', text_size=25,height=50, width=80, text_align=ft.TextAlign.CENTER ,color=ft.colors.RED_300, border_radius=ft.border_radius.all(15)),
                    ],
                    alignment=ft.MainAxisAlignment.SPACE_AROUND,
                    vertical_alignment=ft.CrossAxisAlignment.CENTER,
                ),

                ft.Divider(color=ft.colors.BLACK, height=0.5),

                ft.Row(
                    [
                        ft.Text('Leg Press 45º + Agachamento    P.C 4 x 12 + 10', size=16, color=ft.colors.WHITE, text_align=ft.TextAlign.CENTER),
                    ],
                    alignment=ft.MainAxisAlignment.CENTER,
                ),   
            ]         
            ...
            [
                ft.Row(
                    [
                        ...
                        ft.IconButton(content=ft.Image(src='reset.png', height=30, width=25, color=ft.colors.RED_300)),
                    ],
                    alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                ),
                ...
                ft.Container(
                    ...
                    border_radius=ft.BorderRadius(top_left=1, top_right=1, bottom_left=1, bottom_right=1),
                    border=ft.Border(top=ft.BorderSide(1, color=ft.colors.WHITE), right=ft.BorderSide(1, color=ft.colors.WHITE), left=ft.BorderSide(1, color=ft.colors.WHITE), bottom=ft.BorderSide(1, color=ft.colors.WHITE)),
                    content=ft.Row(
                        [
